...
public class SortUserTest {
    ...
    private User user3 = new User("HasName", 25);
    private User user4 = new User("First", 99);

    @Test
    public void whenAskSortedSetThenReturnIt() {
        su.set.addAll(Arrays.asList(user1, user2, user3, user4));
        assertThat(su.sort(), is(new TreeSet<>(Arrays.asList(user4, user3, user1, user2))));
    }
}
